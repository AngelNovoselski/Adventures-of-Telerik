...
namespace Dealership.Engine
{
    ...
    {
        // Commands constants (do not use these, they serve to the engine)
        ...
        private string AddVehicle(VehicleType type, string make, string model, decimal price, string additionalParam)
        {
            ...
            {
                vehicle = (IVehicle)this.factory.CreateCar(make, model, price, int.Parse(additionalParam));
            }
            else if (type == VehicleType.Motorcycle)
            {
                vehicle = (IVehicle)this.factory.CreateMotorcycle(make, model, price, additionalParam);
            }
            else if (type == VehicleType.Truck)
            {
                vehicle = (IVehicle)this.factory.CreateTruck(make, model, price, int.Parse(additionalParam));
            }
